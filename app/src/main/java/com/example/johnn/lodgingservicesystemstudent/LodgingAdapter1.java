...
public class LodgingAdapter1 extends RecyclerView.Adapter<LodgingAdapter1.ViewHolder>{
    ...
    public LodgingAdapter1(List<Lodging> LodgingList) {
        ll = LodgingList;
    }
    ...
    @Override
    public void onBindViewHolder(LodgingAdapter1.ViewHolder holder, int position) {
        Lodging l = ll.get(position);
        holder.title.setText(l.getTitle());
        holder.price.setText("New message: "+l.getMessage());
    ...
    public void setOnItemClickListener(ClickListener clickListener) {
        LodgingAdapter1.clickListener = clickListener;
    }
